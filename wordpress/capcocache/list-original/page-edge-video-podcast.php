<?php 
/*
Template Name: Edge Film Podcast List Page
*/
get_header(); ?>
<div class="row">
...
<!-- Row for main content area -->
	<div class="ten columns l-article">
	...
	<div class="large-list-boxed l-article">
		<ul>
	<?php
			$course_args = array(
				'post_type' => 'the-edge',
			...
			if ( $wp_query->have_posts() ) {
				while ( $wp_query->have_posts() ) {
					...
					<li>
						<div class="panel-xs">
							<figure class="thumb-absolute">
								<a href="<?php the_permalink(); ?>">
									<img src="<?php echo $thumb_image; ?>">
								</a>
							</figure>
							<div class="large-list-boxed-content ">
								<a href="<?php the_permalink(); ?>">
									<h2><?php the_title(); ?></h2>
								</a>
								<?php the_excerpt(); ?>
