...
function reverie_scripts_and_styles() {
  if (!is_admin()) {
    ...
    */
	...
	wp_register_script( 'liquid-slider', get_template_directory_uri() . '/js/liquid-slider.min.js', array( 'jquery', 'jq-easing', 'jq-touch-swipe', 'liquid-slider-custom' ), '', true );
	...
	wp_register_script( 'raf-script', 'http://mishcon.wellstudio.co.uk/javascripts/script.js', array( 'jquery' ), '', true );
