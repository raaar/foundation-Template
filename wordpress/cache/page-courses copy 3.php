...
function generate_args($current_array, $mq2_query_params, $sticky_query_params){
		return array(
			'post_type' => 'course',
			...
			'meta_query' => array($mq2_query_params, $sticky_query_params)
		);
	}
?>
<!-- Top News Headline Row -->
	<div class="row">
		...
		<div class="eight column offset-by-one end l-article">
			...
			$sticky_query_params = array('key' => 'show_on_top', 'value' => true, 'compare' => '=');
			$sticky_args = generate_args($current_array, $mq2_query_params, $sticky_query_params); 
			
			// Generate course arguments for non sticky posts -
			$sticky_query_params = array('key' => 'show_on_top', 'compare' => 'NOT EXISTS');
			$course_args = generate_args($current_array, $mq2_query_params, $sticky_query_params);
